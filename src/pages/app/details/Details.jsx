...
function Details() {
  ...
  const course = coursesData.find((course)=> course.id ===courseId); //match courseid that is there in url with the course id which is there in courses data and that course get saved inside course
